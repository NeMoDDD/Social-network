...
export const requestsUsers = (currentPage:number, pageSize:number) => {
...
const followUnfollowFlow = async (apiMethod:any, userId:number, dispatch:any, actionCreator:any) => {
